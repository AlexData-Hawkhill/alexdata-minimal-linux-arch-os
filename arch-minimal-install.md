...
This is My personal instructions for how to install a **minimal Linux Arch OS**.    

**A Personal Opinion and a short story for why i cretaed this guide:**
...
## PREPARATIONS - PRE-REQUICITES: 
Things to do before installing Linux on a Windows machine! **Do not skip this step !!!**

Backup your personal windows files to a USB-HDD (or whatever is your preferred backup method!)  
Skipping this step can cost you a loss of ALL your personal files - so again - don't skip it !!
...
_(more details on how to do this will be added here later [until then - google or youtube it] )._  

🐧 This is a fully hands-on-manual-labour-operation - nothing is currently fully automated during this install.  
If you're new to linux - try installing a few distro's first. CachyOS is the one closest to what this guide does!  

Since this is a minimal install, the system is built piece by piece, package by package, to keep it small and functional!    
The guide currently starts from the point where you have booted from your VENTOY usb into the Arch Linux ISO.  
And you're at that stage presented with a bash login prompt from the "LiveCD" you're running via the VenToy formatted USB Stick!  

🔥 **_NB: PS: Following this guide WILL GUARANTEED delete or over-write files, folders, partitions, and possibly whole disks!!_**  
🔥 **_NB: PS: So follow this guide on your own risk! Best practice: Try it out on a new blank virtual machine first! (safe - causes no real damage to any personal files)._**  
(Here are some ways to do so on windows, if you go the virtual route - this guide does it for real: Oracle Virtualbox, VMware, Mss Hyper-v) (Qemu for linux)  
